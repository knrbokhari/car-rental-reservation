...
import { calculateAll } from "../utils/calculate-all";
...
const Receipt = ({ AdditionalChargesData, data }: any) => {
  ...
  return (
    <div className="bg-gray-100 p-10 w-[715px] h-[700px]">
      <div className="flex text-[13px]">
        <div className="w-1/2">
          <div className="flex">
            <div className="w-1/2">
              <Image alt="car" height={200} width={300} src={""} />
        ...
        <div className="w-1/2">
          ...
          <p>REPAIR ORDER:</p>
          <p>CLAIM:</p>
          <p> Date?Time Out: start date</p>
          <p> Date?Time In: start date</p>

          <div className="bg-slate-300 w-full mb-5">
            <h2 className="font-bold text-sm">CHARGE SUMMARY</h2>
